-- ============================================================
-- Seed: 8 môn + 26 chuyên đề + 25 câu mẫu HSG
-- Chạy SAU schema.sql, trong SQL Editor → Run
-- Chạy lại nhiều lần vẫn an toàn (ON CONFLICT DO NOTHING)
-- ============================================================
...
insert into topics (id, subject_id, name, grade) values
...
-- Chỉ seed câu hỏi khi ngân hàng còn trống (tránh trùng khi chạy lại)
do $$
begin
  if (select count(*) from questions) = 0 then
    ...
    values
      ('toan', 'toan-hamso', 12, 'vận dụng', 'trac_nghiem',
       'Cho hàm số y = x^3 - 3x + 1. Số điểm cực trị của đồ thị hàm số là:',
       '["0", "1", "2", "3"]', 'C', 'y'' = 3x^2 - 3 = 0 ⇔ x = ±1 nên có 2 điểm cực trị.', 1, 'mẫu'),
      ('toan', 'toan-hamso', 12, 'thông hiểu', 'trac_nghiem',
       'Giá trị lớn nhất của hàm số y = -x^2 + 4x - 3 trên đoạn [0; 4] là:',
       '["1", "0", "4", "-3"]', 'A', 'Đỉnh parabol tại x = 2, y = 1.', 1, 'mẫu'),
      ('toan', 'toan-tichphan', 12, 'vận dụng cao', 'tu_luan',
      ...
      ('toan', 'toan-hinhkg', 11, 'vận dụng', 'trac_nghiem',
      ...
      ('ly', 'ly-dao-dong', 12, 'vận dụng cao', 'tu_luan',
      ...
      ('van', 'van-nghiluan', 12, 'vận dụng', 'tu_luan',
      ...
      ('anh', 'anh-nguphap', 12, 'vận dụng', 'trac_nghiem',
      ...
      ('cn-nong', 'cn-nong-phanbon', 11, 'vận dụng', 'trac_nghiem',
      ...
      ('cn-nong', 'cn-nong-giong', 11, 'vận dụng', 'tu_luan',
      ...
      ('cn-nong', 'cn-nong-bvtv', 12, 'vận dụng cao', 'tu_luan',
      ...
      ('cn-nong', 'cn-nong-cncao', 12, 'vận dụng', 'trac_nghiem',
      ...
      ('cn-chan', 'cn-chan-giong', 11, 'thông hiểu', 'trac_nghiem',
      ...
      ('cn-chan', 'cn-chan-thucan', 11, 'vận dụng', 'trac_nghiem',
      ...
      ('cn-chan', 'cn-chan-thuy', 12, 'vận dụng cao', 'tu_luan',
      ...
      ('cn-chan', 'cn-chan-chuong', 11, 'vận dụng', 'tu_luan',
      ...
      ('cn-lamthuy', 'cn-lam-rung', 11, 'thông hiểu', 'trac_nghiem',
      ...
      ('cn-lamthuy', 'cn-lam-quanly', 12, 'vận dụng', 'tu_luan',
      ...
      ('cn-lamthuy', 'cn-thuy-nuoi', 12, 'vận dụng', 'trac_nghiem',
      ...
      ('cn-lamthuy', 'cn-thuy-benh', 12, 'vận dụng cao', 'tu_luan',
